...
import cn.wildfirechat.model.ImsInfo;
...
//            }
    ...
    public void ltbLogin(LitappInfo litappInfo, String url, GeneralCallback callback){
        if (mClient != null) {
            try {
                mClient.litappLogin(litappInfo, url, new IGeneralCallback.Stub() {
                    @Override
                    public void onSuccess() throws RemoteException {
                        callback.onSuccess();
                    }
...
//        this.token = token;
    ...
    public void sendBroadcast(final String content, final GeneralCallback callback) {
        ...
        try {
            ...
            json.put("type", "help");
            mClient.broadcast(Base64.encodeToString(json.toString().getBytes(), Base64.NO_WRAP), new cn.wildfirechat.client.IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    mainHandler.post(new Runnable() {
                        @Override
    ...
    public void joinGroup(String groupId, final GeneralCallback callback){
        if (!checkRemoteService()) {
            if (callback != null)
                callback.onFail(ErrorCode.SERVICE_DIED);
            return;
        ...
        try {
            mClient.joinGroup(groupId, new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(new Runnable() {
    ...
    public void muteGroupMember(String groupId, boolean isSet, List<String> memberIds, List<Integer> lines, MessageContent notifyMsg, final GeneralCallback callback) {
        ...
        try {
            mClient.muteOrAllowGroupMember(groupId, isSet, memberIds, false, inlines, content2Payload(notifyMsg), new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(() -> callback.onSuccess());
    ...
    public void allowGroupMember(String groupId, boolean isSet, List<String> memberIds, List<Integer> lines, MessageContent notifyMsg, final GeneralCallback callback) {
        ...
        try {
            mClient.muteOrAllowGroupMember(groupId, isSet, memberIds, true, inlines, content2Payload(notifyMsg), new IGeneralCallback.Stub() {
                @Override
                public void onSuccess() throws RemoteException {
                    if (callback != null) {
                        mainHandler.post(() -> callback.onSuccess());
