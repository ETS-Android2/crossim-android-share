...
public class MainActivity extends WfcBaseActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void afterViews() {
        UiWrapper.setUiCallback(new UiWrapper.UiCallback() {
            @Override
            public void getNotificationIcon(NotificationCompat.Builder builder) {
            ...
            public void onUiSuccess(String s) {
                try {
                    ...
                    if(!versionNew.equalsIgnoreCase(versionName)){
                        ...
                        builder.setTitle("发现新版本：" + versionNew);
                        builder.show();
                    }
                }
                catch (Exception e){
    ...
    private void initView() {
        ...
        mFragmentList.add(litappGridFragment);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.conversation_list:
                    ...
                    setTitle(getString(R.string.page_app));
                    if (!isDarkTheme()) {
