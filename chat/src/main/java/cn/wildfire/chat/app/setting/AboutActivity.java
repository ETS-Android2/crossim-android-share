...
//            }
    ...
    public void intro() {
        WfcWebViewActivity.loadUrl(this, "跨云IM功能介绍", "http://www.crossim.im/");
    }

    @OnClick(R.id.agreementOptionItemView)
    public void agreement() {
        WfcWebViewActivity.loadUrl(this, "跨云IM用户协议", "http://www.crossim.im/useragm.htm");
    }

    @OnClick(R.id.privacyOptionItemView)
    public void privacy() {
        WfcWebViewActivity.loadUrl(this, "跨云IM个人信息保护政策", "http://www.crossim.im/privacy.htm");
    }
}
